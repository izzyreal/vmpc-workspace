...
first_cert = subprocess.check_output("security find-certificate -c \"Apple Development\" -p | openssl x509 -subject", universal_newlines=True, shell=True)
...
if end_index == -1:
    raise Exception("Only find organisational unit start marker '\OU=' was found. " +
                    "Failed to end marker '/O'  in what seems to be " +
