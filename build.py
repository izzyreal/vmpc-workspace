...
parser.add_argument('buildtool', help='The build tool you want to build the workspace for. Options are vs, vs32, xcode and ninja.')
...
if args.buildtool != 'vs' and args.buildtool != 'vs32' and args.buildtool != 'xcode' and args.buildtool != 'ninja':
    print('Build tool has to be vs, vs32, xcode or ninja')
    quit()
